...
beforeAll(() => {
  expectedStylishResult = readFixture('expected-result-stylish.txt');
  expectedPlainResult = readFixture('expected-result-plain.txt');
  expectedJsonResult = readFixture('expected-result-json.json');
});
